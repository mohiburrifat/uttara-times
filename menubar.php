<?php
/*──────────────────────────────────────────────────────────────
  editor_menubar.php   –   Navbar + Sidebar (responsive)
──────────────────────────────────────────────────────────────*/
...
<nav class="navbar">
    <!-- 3-bar hamburger -->
    <button class="navbar-toggler" id="toggleSidebar" aria-label="Menu">
    ...
    <span class="navbar-brand mx-auto">Uttara-Times</span>

    <!-- Top Links -->
    <div class="d-none d-md-flex gap-3 mx-3">
        <a href="faq.php" class="fw-semibold text-decoration-none text-primary">FAQ</a>
        <a href="about.php" class="fw-semibold text-decoration-none text-primary">About Us</a>
    <a href="contact.php" class="fw-semibold text-decoration-none text-primary">Our Team</a>
    </div>

    <!-- profile circle -->
    <!-- profile circle -->
    <div class="ms-auto profile-wrapper position-relative">
...
<!-- overlay (only shown on tablet / mobile when sidebar floats) -->
...
<style>
    ...
    @media (min-width:992px) {
        ...
        /* optional: push content right when sidebar is open */
        body.sidebar-open {
            margin-left: 255px;
