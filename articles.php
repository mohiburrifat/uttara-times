...
<head>
    ...
    <title>All Articles | Uttara-Times</title>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle text-center">
                    ...
                    <tbody>
                        <?php
                        $stmt = $conn->prepare("
                            SELECT a.article_id, a.title, a.status, a.created_at, u.username 
                            FROM articles a 
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <?php foreach (['draft', 'pending', 'approved', 'declined'] as $statusOption): ?>
                                                <?php if ($statusOption !== $row['status']): ?>
                                                    <li>
                                                        <a class="dropdown-item change-status" href="#" data-id="<?= $row['article_id'] ?>" data-status="<?= $statusOption ?>">
